...
import { AuthFlow, BackgroundShapes, SecureIcon } from "./visuals";
  ...
  return (
    <PageShell>
      <main className="relative overflow-hidden px-5 py-12 sm:px-8 lg:py-20">
        <BackgroundShapes />
        <div className="relative mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-center">
          <GlassCard className="order-2 p-7 lg:order-1 lg:p-9">
